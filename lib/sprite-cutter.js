...
function writeBitsCallback(config) {
    ...
    return function (spriteObject) {
        ...
        writeRow(spriteObject.normal.width, config['select-height'], 'select-right_active-hover');
        ...
        writeRow(config['select-margin-left'], config['select-height'], 'select-left_active-hover');
        writeRow(config['select-margin-left'], config['select-height'], 'select-left_disabled');

        // Checkboxes
        writeRow(config['checkbox-width'], config['checkbox-height'], 'checkbox checkbox_active checkbox_hover checkbox_active-hover checkbox_checked checkbox_active-checked checkbox_checked-hover checkbox_active-checked-hover checkbox_disabled checkbox_checked-disabled');

        // Radios
        writeRow(config['radio-width'], config['radio-height'], 'radio radio_active radio_hover radio_active-hover radio_checked radio_active-checked radio_checked-hover radio_active-checked-hover radio_disabled radio_checked-disabled');
        ...
        writeRow(spriteObject.normal.width, config['upload-height'], 'file-button-right');
        writeRow(spriteObject.normal.width, config['upload-height'], 'file-button-right_active');
        writeRow(spriteObject.normal.width, config['upload-height'], 'file-button-right_hover');
        writeRow(spriteObject.normal.width, config['upload-height'], 'file-button-right_active-hover');
        writeRow(spriteObject.normal.width, config['upload-height'], 'file-button-right_disabled');
