...
"mouseup touchend":function(){c.removeClass(b.activeClass)},"click touchend":function(){var b=a.find(":selected").html();d.html()!==b&&a.trigger("change")},mouseenter:function(){c.addClass(b.hoverClass)},mouseleave:function(){c.removeClass(b.hoverClass);c.removeClass(b.activeClass)},keyup:function(){d.html(a.find(":selected").html())}});i(c,a,b);e.uniform.noSelect(d);f=a.width();c.width(f);d.width(f-25);return a},remove:function(a){a.siblings("span").remove();a.unwrap();return a},update:function(a,
b){var c,d;c=a.siblings("span");d=a.parent("div");k(d,b);c.html(a.find(":selected").html());i(d,a,b)}},{match:function(a){return a.is("textarea")},apply:function(a){a.addClass("uniform");return a},remove:function(){},update:function(){}}];e.browser.msie&&7>e.browser.version&&(n=!1);e.fn.uniform=function(a){var b=this,a=e.extend({},e.uniform.defaults,a);!1!==a.resetSelector&&e(a.resetSelector).mouseup(function(){window.setTimeout(function(){e.uniform.update(b)},10)});return this.each(function(){var b=
e(this),d,f;if(!b.data("uniformed")&&n)for(d=0;d<p.length;d+=1)if(f=p[d],f.match(b,a)){f.apply(b,a);b.data("uniformed",{options:a,remove:f.remove,update:f.update});e.uniform.elements.push(b.get(0));break}})};e.uniform.restore=function(a){a===l&&(a=e.uniform.elements);e(a).each(function(){var a=e(this),c;if(c=a.data("uniformed"))c.remove(a,c.options),a.unbind(".uniform"),a.css("opacity","1"),c=e.inArray(this,e.uniform.elements),0<=c&&e.uniform.elements.splice(c,1),a.removeData("uniformed")})};e.uniform.noSelect=
function(a){var b=function(){return!1};e(a).each(function(){this.onselectstart=this.ondragstart=b;e(this).mousedown(b).css({MozUserSelect:"none"})})};e.uniform.update=function(a){a===l&&(a=e.uniform.elements);e(a).each(function(){var a=e(this),c;(c=a.data("uniformed"))&&c.update(a,c.options)})}})(jQuery);
