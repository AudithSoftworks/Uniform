...
* button normal (was browser cap normal or omitted)
* button active (was browser cap hover or omitted)
* button hover (was browser cap active or omitted)
* button disabled (was browser cap disabled or omitted)

* button cap normal (was browser normal or omitted)
* button cap active (was browser hover or omitted)
* button cap hover (was browser active or omitted)
* button cap disabled (was browser disabled or omitted)
